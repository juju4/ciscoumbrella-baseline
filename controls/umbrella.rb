...
umbrella_org_id = input('umbrella_org_id', value: false, description: 'Check Umbrella use the correct Org ID')
...
control 'umbrella-1.0' do
  ...
  describe http('https://www.examplemalwaredomain.com', ssl_verify: false) do
    its('status') { should cmp 200 }
    its('body') { should include 'examplemalwaredomain.com is only a demonstration site.' }
